...
public class Register {
    ...
    private static final String REQUEST_URL = "http://api.fengkongcloud.com/v2/saas/register";
    ...
    public static void main(String[] args) {
        ...
        data.put("registerTime", 1477034215); // 用户注册时间
        data.put("ip", "127.0.0.1"); // 用户注册的ip
