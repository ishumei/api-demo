...
public class DttRecords {
    private static final String ACCESSKEY="xxxxxxxx"; // 商户的 accessKey
    private static final String REQUEST_URL = "https://finance-api.fengkongcloud.com//v2/saas/finance/dttrecords";
    private static final String SECRETKEY = "xxxxxxx"; // 商户的secretKey
    ...
    public static void main(String[] args) {
        ...
        // 设置请求参数
        data.put("deviceId", "2017082009443505461345cec227d6f4e14791aeeacf9b018798d5a4492293");
        data.put("startTime", Long.valueOf(1504803661000L));
        ...
        if (json.getInt("code")== 1100) {
            ...
            String encrySms = json.getJSONObject("detail").getString("records");
            ...
            if (!StringUtils.isEmpty(encrySms)) {
                ...
                if (!StringUtils.isEmpty(sms)) {
                    ...
                    for (Object obj : jsonData) {
                        ...
                        System.out.println("phone=" + phone + ", duration=" + duration + ",time=" + time);
                    }
                }
            }
        } else {
